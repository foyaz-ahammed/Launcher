...
class LawnchairPreferences(val context: Context) : SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private val reloadIcons = { reloadIcons(true) }
    ...
    val usePopupMenuView by BooleanPref("pref_desktopUsePopupMenuView", false, doNothing)
    ...
    fun reloadIcons(changedTheme: Boolean = false) {
        if (changedTheme) {
