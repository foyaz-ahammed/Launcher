...
class DynamicDrawable {
    companion object {
         ...
         * @param drawable 얻으려는 icon 의 기초 drawable
         * @param metadata clock 관련 자료
         ...
         * Xml 을 얻는 함수
         * @param context The application context
         * @param name drawable resource 이름
         * @param packageName xml 관련 package 이름
         */
         ...
         * Drawable 을 얻는 함수
         * @param context The application context
         * @param packageName drawable 관련 package 이름
         * @param name drawable resource 이름
         * @param density drawable 밀도
         */
