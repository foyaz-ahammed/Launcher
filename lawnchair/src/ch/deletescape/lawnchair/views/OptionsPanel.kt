...
class OptionsPanel(context: Context, attrs: AttributeSet) : LinearLayout(context, attrs),
    ...
    override fun onFinishInflate() {
        ...
        //Get bottom margin from resource
        bottomMargin = resources.getDimension(R.dimen.options_view_bottom_margin);
    }
    ...
    override fun onClick(v: View) {
        when (v.id) {
            ...
            R.id.transition_button -> OptionsPopupView.openTransitions(v)
        }
    }
    ...
    override fun setInsets(insets: Rect) {
        ...
        layoutParams = (layoutParams as FrameLayout.LayoutParams).also { lp ->
            ...
            lp.bottomMargin = insets.bottom + bottomMargin.toInt()
        }
    }
}
