...
public class AllAppsState extends LauncherState {
    ...
    private static final float ALL_APPS_SCALE_VALUE = 0.85f;
    ...
    public float[] getWorkspaceScaleAndTranslation(Launcher launcher) {
        ...
        //Set scale value 0.8f(ALL_APPS_SCALE_VALUE)
        //Set translation value 0
        scaleAndTranslation[0] = ALL_APPS_SCALE_VALUE;
        scaleAndTranslation[2] = 0;
