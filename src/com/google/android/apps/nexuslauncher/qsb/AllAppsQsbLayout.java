...
public class AllAppsQsbLayout extends AbstractQsbLayout implements SearchUiManager, o,
        OnClickListener, ColorEngine.OnColorChangeListener {
    ...
    public AllAppsQsbLayout(Context context, AttributeSet attributeSet) {
        ...
        mSearchTextColor = getResources().getColor(R.color.all_apps_search_text_color, null);
    }
    ...
    public void setInsets(Rect rect) {
        ...
        if (mActivity.getDeviceProfile().isVerticalBarLayout()) {
            ...
            //Get bottom margin
            int bottomMargin = mActivity.getDeviceProfile().getInsets().bottom + mActivity.getResources()
                    .getDimensionPixelSize(R.dimen.hotseat_qsb_bottom_margin);
            float delta = bottomMargin + Dy;
    ...
    public void onColorChange(@NotNull ResolveInfo resolveInfo) {
        if (resolveInfo.getKey().equals(Resolvers.ALLAPPS_QSB_BG)) {
            ...
            ay(getResources().getColor(R.color.all_apps_background_color));
            az(this.Dc);
        }
    }
    ...
    private void ensureFallbackView() {
        if (mFallback == null) {
            ...
            mFallback.setTextColor(mSearchTextColor);
        }
    }
    ...
    public void draw(Canvas canvas) {
        this.mShadowHelper.paint.setAlpha(40);
