...
public class LauncherSettings {
     ...
     * Quick Access
     */
    public static final class QuickAccess implements BaseColumns{
        public static final String TABLE_NAME = "quickAccess";
        ...
        /**
         * Shortcut Id given on DeepShortcutManager
         */
        public static final String SHORTCUT_ID = "shortcutId";

        /**
         * Package Name of the shortcut
         */
    ...
    /**
     * Assistant section order
     */
    public static final class AssistantSectionOrder implements BaseColumns {
        public static final String TABLE_NAME = "assistantSectionOrder";
        ...
        public static final String ESTIMATION_CURRENT_INDEX = "estimationCurrentIndex";
        public static final String ESTIMATION_PINNED_STATUS = "estimationPinnedStatus";

        public static final String CALENDAR_CURRENT_INDEX = "calendarCurrentIndex";
        public static final String CALENDAR_PINNED_STATUS = "calendarPinnedStatus";

        public static final String CLOCK_CURRENT_INDEX = "clockCurrentIndex";
        public static final String CLOCK_PINNED_STATUS = "clockPinnedStatus";

        public static final String CONTACTS_CURRENT_INDEX = "contactsCurrentIndex";
        public static final String CONTACTS_PINNED_STATUS = "contactsPinnedStatus";

        public static void addTableToDb(SQLiteDatabase db, boolean optional) {
            String ifNotExists = optional ? " IF NOT EXISTS " : "";
            db.execSQL("CREATE TABLE " + ifNotExists + TABLE_NAME + " (" +
                    _ID + " INTEGER PRIMARY KEY NOT NULL DEFAULT 0, " +
                    ESTIMATION_CURRENT_INDEX + " INTEGER NOT NULL DEFAULT 3, " +
                    ESTIMATION_PINNED_STATUS + " INTEGER NOT NULL DEFAULT 0, " +
                    CALENDAR_CURRENT_INDEX + " INTEGER NOT NULL DEFAULT 4, " +
                    CALENDAR_PINNED_STATUS + " INTEGER NOT NULL DEFAULT 0, " +
                    CLOCK_CURRENT_INDEX + " INTEGER NOT NULL DEFAULT 5, " +
                    CLOCK_PINNED_STATUS + " INTEGER NOT NULL DEFAULT 0, " +
                    CONTACTS_CURRENT_INDEX + " INTEGER NOT NULL DEFAULT 6, " +
                    CONTACTS_PINNED_STATUS + " INTEGER NOT NULL DEFAULT 0, " +
                    LauncherSettings.ChangeLogColumns.MODIFIED + " INTEGER NOT NULL DEFAULT 0" +
                    ");");
        }
    }
