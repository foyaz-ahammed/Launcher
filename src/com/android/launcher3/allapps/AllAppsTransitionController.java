...
public class AllAppsTransitionController implements StateHandler, OnDeviceProfileChangeListener,
    ...
    public void setProgress(float progress) {
        ...
        if (!mIsVerticalLayout) {
            //Remove the translate animation of hotseat
            //float hotseatTranslation = -mShiftRange + shiftCurrent;
            //mLauncher.getHotseat().setTranslationY(hotseatTranslation);

            //Set 10x speed
            float pageIndicatorAlpha = 1 - (1 - progress)*10;
            mLauncher.getWorkspace().getPageIndicator().setAlpha(pageIndicatorAlpha);
        }
    ...
    private void setAlphas(LauncherState toState, AnimationConfig config,
        ...
        //Apply alpha for top parent view, not to individual children
        setter.setViewAlpha(mAppsView, hasContent ? 1 : 0, allAppsFade);
