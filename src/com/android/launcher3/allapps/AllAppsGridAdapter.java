 ...
 */
public class AllAppsGridAdapter extends RecyclerView.Adapter<AllAppsGridAdapter.ViewHolder> implements
        SectionIndexer {
    ...
    //Variables needed for alphabetical sort
    private String mSections = "#ABCDEFGHIJKLMNOPQRSTUVWXYZ";

    /**
     * Section 목록을 돌려주는 함수
     * 조선어 혹은 영어의 매 자모들을 포함하는 목록을 돌려준다.
     * @return Section 목록
     */
    @Override
    public Object[] getSections() {
        String currentLanguage = Locale.getDefault().toLanguageTag();
        if(currentLanguage.startsWith("ko")){
            mSections = "#ㄱㄴㄷㄹㅁㅂㅅㅇㅈㅊㅋㅌㅍㅎZ";
        }
        else{
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        switch (viewType) {
            case VIEW_TYPE_ICON:
                ...
                icon.setLongPressTimeout(Utilities.ALL_APPS_ICON_LONG_PRESS_DURATION);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        switch (holder.getItemViewType()) {
            case VIEW_TYPE_ICON:
                ...
                icon.setTextColor(mLauncher.getColor(R.color.all_apps_text_color));
                break;
            case VIEW_TYPE_EMPTY_SEARCH:
