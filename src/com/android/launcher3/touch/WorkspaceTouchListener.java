...
public class WorkspaceTouchListener extends GestureTouchListener implements OnTouchListener, Runnable {
    ...
    public boolean onTouch(View view, MotionEvent ev) {
        ...
        if (action == ACTION_DOWN) {
            ...
            if (handleLongPress) {
                ...
                mWorkspace.postDelayed(this, Utilities.WORKSPACE_LONG_PRESS_DURATION);
            }
        ...
        if (mLongPressState == STATE_COMPLETED) {
            ...
            //we don't need to cancel long press although workspace is handling touch on normal mode
            if (mWorkspace.isHandlingTouch() && !mLauncher.isInState(NORMAL)) {
                cancelLongPress();
            }
    ...
    private boolean canHandleLongPress() {
        return (AbstractFloatingView.getTopOpenView(mLauncher) == null
                ...
                && !mWorkspace.isTransitionAnimationRunning();
    }
