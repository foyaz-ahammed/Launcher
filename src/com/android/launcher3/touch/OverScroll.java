...
public class OverScroll {
    ...
    private static final float OVERSCROLL_DAMP_FACTOR = 0.37f;
    ...
    public static int invertedDampScroll(int result, int max){
        double f = result/(OVERSCROLL_DAMP_FACTOR * max);
        f = Math.pow(Math.abs(f - 1), 1.0f/3);
        f = 1 - f;
