...
public class DropTargetBar extends FrameLayout
    ...
    private static final int VERTICAL_MOVE_DISTANCE = 60;
    ...
    public void setInsets(Rect insets) {
        ...
        if (grid.isVerticalBarLayout()) {
            ...
            //Set padding
            lp.topMargin -= DeviceProfile.DROP_TARGET_PADDING;
        ...
        if (mVisible != isVisible) {
            ...
            if (Float.compare(getAlpha(), finalAlpha) != 0) {
                ...
                if(mLauncher.isInState(LauncherState.OPTIONS)){
                    if(isVisible){
                        setTranslationY(-VERTICAL_MOVE_DISTANCE);
                        mCurrentAnimation = mCurrentAnimation.translationYBy(VERTICAL_MOVE_DISTANCE);
                    }
                    else {
                        setTranslationY(0);
                        mCurrentAnimation = mCurrentAnimation.translationYBy(-VERTICAL_MOVE_DISTANCE);
