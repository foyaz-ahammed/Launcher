...
public class PreviewBackground {
    ...
    private static final int BG_OPACITY = 90;
    ...
    public void setup(Launcher launcher, View invalidateDelegate,
        ...
        //Define a color, and use it
//        mBgColor = Themes.getAttrColor(launcher, android.R.attr.colorPrimary);
        mBgColor = launcher.getColor(R.color.folder_preview_background_color);
    ...
    public void drawBackgroundStroke(Canvas canvas) {
        //In this case, use alpha low opacity
        mPaint.setColor(ColorUtils.setAlphaComponent(mBgColor, 30/*mStrokeAlpha*/));
