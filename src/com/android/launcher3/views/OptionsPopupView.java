...
public class OptionsPopupView extends ArrowPopup
    ...
    public static boolean openWidgets(Launcher launcher) {
        if (launcher.getPackageManager().isSafeMode()) {
            ...
            //Page indicator, hotseat, etc should be invisible this time
            launcher.hideViewsForWidgetDialog();
    ...
    public static boolean openTransitions(View view){
        TransitionLayout.show(Launcher.getLauncher(view.getContext()));
        return true;
    }
