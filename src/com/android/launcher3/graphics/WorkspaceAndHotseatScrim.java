...
public class WorkspaceAndHotseatScrim implements
    ...
    public WorkspaceAndHotseatScrim(View view) {
        ...
        mRoundRectCornerRadius = view.getResources().getDimension(R.dimen.cell_layout_background_radius);
    }
    ...
    public void draw(Canvas canvas) {
        ...
        if (mScrimAlpha > 0) {
            ...
            if (currCellLayout != null && currCellLayout != mLauncher.getHotseat().getLayout()
                ...
                //Set the round rect path
                mHighlightPath.reset();
                mHighlightPath.addRoundRect(new RectF(mHighlightRect), mRoundRectCornerRadius,
                        mRoundRectCornerRadius, Direction.CW);

                canvas.clipPath(mHighlightPath, Region.Op.DIFFERENCE);
            }
