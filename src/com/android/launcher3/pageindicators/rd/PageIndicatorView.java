...
import com.android.launcher3.pageindicators.rd.draw.data.PositionSavedState;
...
import com.android.launcher3.pageindicators.rd.utils.IdUtils;
...
public class PageIndicatorView extends View implements ViewPager.OnPageChangeListener, IndicatorManager.Listener, ViewPager.OnAdapterChangeListener {
	...
	private void onPageScroll(int position, float positionOffset) {
        ...
        Pair<Integer, Float> progressPair = CoordinatesUtils
                .getProgress(indicator, position, positionOffset, isRtl());
