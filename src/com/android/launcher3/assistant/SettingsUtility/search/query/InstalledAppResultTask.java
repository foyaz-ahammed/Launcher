...
import com.android.launcher3.assistant.SettingsUtility.search.indexing.DatabaseIndexingUtils;
...
public class InstalledAppResultTask extends SearchQueryTask.QueryWorker {
    ...
    public static final int QUERY_WORKER_ID =
            SettingsIntelligenceLogProto.SettingsIntelligenceEvent.EventType.SEARCH_QUERY_INSTALLED_APPS;
    ...
    protected List<? extends SearchResult> query() {
        ...
        @SuppressLint("WrongConstant") List<ApplicationInfo> appsInfo = mPackageManager.getInstalledApplications(
