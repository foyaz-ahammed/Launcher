...
package com.android.launcher3.assistant.SettingsUtility.search.indexing;

import static com.android.launcher3.assistant.SettingsUtility.search.SearchFeatureProvider.DEBUG;
import static com.android.launcher3.assistant.SettingsUtility.search.indexing.IndexDatabaseHelper.IndexColumns.CLASS_NAME;
import static com.android.launcher3.assistant.SettingsUtility.search.indexing.IndexDatabaseHelper.IndexColumns.DATA_AUTHORITY;
import static com.android.launcher3.assistant.SettingsUtility.search.indexing.IndexDatabaseHelper.IndexColumns.DATA_ENTRIES;
import static com.android.launcher3.assistant.SettingsUtility.search.indexing.IndexDatabaseHelper.IndexColumns.DATA_KEYWORDS;
import static com.android.launcher3.assistant.SettingsUtility.search.indexing.IndexDatabaseHelper.IndexColumns.DATA_KEY_REF;
import static com.android.launcher3.assistant.SettingsUtility.search.indexing.IndexDatabaseHelper.IndexColumns.DATA_PACKAGE;
import static com.android.launcher3.assistant.SettingsUtility.search.indexing.IndexDatabaseHelper.IndexColumns.DATA_SUMMARY_ON;
import static com.android.launcher3.assistant.SettingsUtility.search.indexing.IndexDatabaseHelper.IndexColumns.DATA_SUMMARY_ON_NORMALIZED;
import static com.android.launcher3.assistant.SettingsUtility.search.indexing.IndexDatabaseHelper.IndexColumns.DATA_TITLE;
import static com.android.launcher3.assistant.SettingsUtility.search.indexing.IndexDatabaseHelper.IndexColumns.DATA_TITLE_NORMALIZED;
import static com.android.launcher3.assistant.SettingsUtility.search.indexing.IndexDatabaseHelper.IndexColumns.ENABLED;
import static com.android.launcher3.assistant.SettingsUtility.search.indexing.IndexDatabaseHelper.IndexColumns.ICON;
import static com.android.launcher3.assistant.SettingsUtility.search.indexing.IndexDatabaseHelper.IndexColumns.INTENT_ACTION;
import static com.android.launcher3.assistant.SettingsUtility.search.indexing.IndexDatabaseHelper.IndexColumns.INTENT_TARGET_CLASS;
import static com.android.launcher3.assistant.SettingsUtility.search.indexing.IndexDatabaseHelper.IndexColumns.INTENT_TARGET_PACKAGE;
import static com.android.launcher3.assistant.SettingsUtility.search.indexing.IndexDatabaseHelper.IndexColumns.PAYLOAD;
import static com.android.launcher3.assistant.SettingsUtility.search.indexing.IndexDatabaseHelper.IndexColumns.PAYLOAD_TYPE;
import static com.android.launcher3.assistant.SettingsUtility.search.indexing.IndexDatabaseHelper.IndexColumns.SCREEN_TITLE;
import static com.android.launcher3.assistant.SettingsUtility.search.indexing.IndexDatabaseHelper.Tables.TABLE_PREFS_INDEX;
import static com.android.launcher3.assistant.SettingsUtility.search.query.DatabaseResultTask.SELECT_COLUMNS;
...
import com.android.launcher3.assistant.SettingsUtility.search.sitemap.SiteMapPair;
    ...
    public class IndexingTask extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            FeatureFactory.get(mContext).metricsFeatureProvider(mContext).logEvent(
                    SettingsIntelligenceLogProto.SettingsIntelligenceEvent.EventType.INDEX_SEARCH,
                    indexingTime);
