...
public abstract class BaseRecyclerView extends RecyclerView implements OnColorChangeListener {
    ...
    //Flag value to use index scroller or not
    public boolean mUseIndexScroller = false;
    ...
    public boolean shouldContainerScroll(MotionEvent ev, View eventSource) {
        ...
        if(useIndexScroller()){
            IndexFastScrollRecyclerSection scroller = ((AllAppsRecyclerView)this).getIndexScroller();
            if(scroller.isIndexing())
                return false;
