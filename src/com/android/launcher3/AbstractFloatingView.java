...
public abstract class AbstractFloatingView extends LinearLayout implements TouchController {
    ...
    //Transition Layout
    public static final int TYPE_TRANSITION_BOTTOM_SHEET = 1 << 9;

    // Popups related to quickstep UI
    public static final int TYPE_QUICKSTEP_PREVIEW = 1 << 10;
    ...
    public static final int TYPE_ALL = TYPE_FOLDER | TYPE_ACTION_POPUP
            ...
            | TYPE_OPTIONS_POPUP | TYPE_SETTINGS_SHEET | TYPE_SNACKBAR | TYPE_TRANSITION_BOTTOM_SHEET;

    // Type of popups which should be kept open during launcher rebind
    public static final int TYPE_REBIND_SAFE = TYPE_WIDGETS_FULL_SHEET
            | TYPE_QUICKSTEP_PREVIEW | TYPE_ON_BOARD_POPUP | TYPE_DISCOVERY_BOUNCE | TYPE_TRANSITION_BOTTOM_SHEET;
