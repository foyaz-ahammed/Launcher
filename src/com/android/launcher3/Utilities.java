...
public final class Utilities {
    ...
    //delay time for long press
    public static final int WORKSPACE_LONG_PRESS_DURATION = 600;
    public static final int ALL_APPS_ICON_LONG_PRESS_DURATION = 500;
    public static final int DESKTOP_ICON_LONG_PRESS_DURATION = 500;
    ...
    public static int getFloorInteger(float input){
        int round = Math.round(input);
        if(round == input)
            return round;
        return round + 1;
    }
