...
import ch.deletescape.lawnchair.ThemeChangeReceiver;
...
public class LoaderTask implements Runnable {
                    ...
                    try {
                        ...
                        case LauncherSettings.Favorites.ITEM_TYPE_DEEP_SHORTCUT:
                            ...
                            if (c.restoreFlag != 0) {
                                ...
                                if(intent.getBooleanExtra(Sesame.EXTRA_TAG, false)) {
    ...
    private void loadAllApps() {
        ...
        //send broadcast to themes app for finishing progress dialog
        if (ThemeChangeReceiver.isBroadcastReceived) {
            Intent sharedIntent = new Intent();
            sharedIntent.setPackage("com.android.themes");
            sharedIntent.setAction("ch.deletescape.lawnchair.dev.action.LOAD_ALL_ICONS");
            this.mApp.getContext().sendBroadcast(sharedIntent);

            ThemeChangeReceiver.isBroadcastReceived = false;
        }
