...
public class WidgetsFullSheet extends BaseWidgetSheet
        ...
        findViewById(R.id.back_button).setOnClickListener(
                new View.OnClickListener(){
                    ...
                    public void onClick(View v) {
                        WidgetsFullSheet.this.onBackPressed();
                    }
                }
        );
    }
    ...
    public void setInsets(Rect insets) {
        ...
        mRecyclerView.setNavBarHeight(mInsets.bottom);
        requestLayout();
    }
    ...
    protected void handleClose(boolean animate) {
        ...
        //Show the views that get hidden when widget dialog is opened
        mLauncher.showViewsForWidgetDialog();
    }
